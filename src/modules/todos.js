...
export const insert = createAction(INSERT, txt => (
    {id: id++, txt, done: false}
))
// export const insert = txt => ({
//    type: INSERT,
//    todo:{id: id++, txt, done: false}
// });
...
const initialState = {
    input: '',
    todos: [
        {id: 1, txt: '리덕스 기초 배우기', done: true},
        {id: 2, txt: '리액트와 리덕스 사용하기', done: false}
    ]
}
